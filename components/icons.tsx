...
export const CodemoIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        clipRule="evenodd"
        d="M2 1L1 2L2 3L1 4L2 5L1 6L2 7L1 8L2 9L1 10L2 11L1 12L2 13L1 14L2 15L3 14L4 15L5 14L6 15L7 14L8 15L9 14L10 15L11 14L12 15L13 14L14 15L15 14L14 13L15 12L14 11L15 10L14 9L15 8L14 7L15 6L14 5L15 4L14 3L15 2L14 1L13 2L12 1L11 2L10 1L9 2L8 1L7 2L6 1L5 2L4 1L3 2L2 1ZM3 3H4V4H3V3ZM5 3H6V4H5V3ZM7 3H8V4H7V3ZM9 3H10V4H9V3ZM11 3H12V4H11V3ZM13 3H14V4H13V3ZM3 5H4V6H3V5ZM5 5H6V6H5V5ZM7 5H8V6H7V5ZM9 5H10V6H9V5ZM11 5H12V6H11V5ZM13 5H14V6H13V5ZM3 7H4V8H3V7ZM5 7H6V8H5V7ZM7 7H8V8H7V7ZM9 7H10V8H9V7ZM11 7H12V8H11V7ZM13 7H14V8H13V7ZM3 9H4V10H3V9ZM5 9H6V10H5V9ZM7 9H8V10H7V9ZM9 9H10V10H9V9ZM11 9H12V10H11V9ZM13 9H14V10H13V9ZM3 11H4V12H3V11ZM5 11H6V12H5V11ZM7 11H8V12H7V11ZM9 11H10V12H9V11ZM11 11H12V12H11V11ZM13 11H14V12H13V11ZM3 13H4V14H3V13ZM5 13H6V14H5V13ZM7 13H8V14H7V13ZM9 13H10V14H9V13ZM11 13H12V14H11V13ZM13 13H14V14H13V13Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
